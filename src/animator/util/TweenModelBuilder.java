...
public interface TweenModelBuilder<T> {
   ...
   * @param name the unique name of the shape whose scale is to be changed
   * @param fromSx the old x dimension of the shape
   * @param fromSy the old y dimension of the shape
   * @param toSx the new x dimension of the shape
   * @param toSy the new y dimension of the shape
   * @param startTime the time tick at which this scale change should start
   * @param endTime the time tick at which this scale change should start
   * @return the builder object
   */
